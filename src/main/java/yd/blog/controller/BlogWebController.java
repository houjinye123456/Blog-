...
import yd.blog.exception.ArticleNotFoundException;
...
public class BlogWebController {
	...
	public String index(Model model, ArticleConditionVo vo) {
		...
		String blogname = bizThemeService.selectCurrent().getName();
		return THEME_PREFIX + blogname + "/index";
	}
